<%-- 
    ...
    Created on : 15-Nov-2023, 5:48:08 pm
    Author     : Dell
--%>
    ...
    <body>
        ...
        <div class="row" style="width:100%;">
            <div class="col-md-8 col-sm-12">
                ...
                <form  method="post" class="receptionForm" action="Doctor_registration_backend.jsp">
                    <h3>Doctors Registration UI</h3>
                    <div class="row">
                        <div class="col-12">
                            <label for="username">Doctor Name:</label>
                            <input type="text" name="receptionName" required><br>
                            <label for="emailId" class="mt-0">Doctor DOB</label>
                            <input type="date" name="receptionDOB" required><br>
                            <label for="mobileNo" class="mt-0">Doctor Qualifications:</label>
                            <input type="text" name="receptionQualifications" required><br>
                            <label for="ChildName" class="mt-0">Doctor Mail Id:</label>
                            <input type="text" name="receptionMail" required><br>
                            <label for="ChildName" class="mt-0">Doctor Mobile:</label>
                            <input type="text" name="receptionMobile" required><br>
                            <label for="ChildName" class="mt-0">Doctor Address:</label>
