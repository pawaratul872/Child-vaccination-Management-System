<%-- 
    Document   : reception_registration_backend
    Created on : 15-Nov-2023, 5:21:51 pm
    Author     : Dell
--%>
...
String insertQuery = "INSERT INTO receptions_registration (receptionName, receptionDOB, receptionQualifications, receptionMail, receptionMobile, receptionAddress) "
        + "VALUES (?, ?, ?, ?, ?, ?)";
...
try {
    ...
    pstmtLogin.setString(3, "Reception");
